...
save('RLPGJAYA_FO_dynamic') % save results of the fractional order model

%save('RLPGJAYA_IO_dynamic') % save results of the integer order model
% % %
