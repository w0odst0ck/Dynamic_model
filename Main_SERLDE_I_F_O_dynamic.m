...
save('SERLDE_FO_dynamic') % save results of the fractional order model

%save('SERLDE_IO_dynamic') % save results of the integer order model
% % %
%% For Integer order m  model
% 
% load('SERLDE_IO_dynamic.mat')
